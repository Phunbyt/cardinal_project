...
const AttendanceDetails = () => {
   ...
   return (
      <div style={{ marginTop: "1.5em" }}>
         ...
         >
            <h3 style={{ margin: 0 }}>
               47TH GENERAL MEETING ATTENDANCE DETAILS
            </h3>
         </div>
         <AttendanceItem
            columnOneText="S/N"
            ...
            {chairman.map((item, index) => {
               ...
               return (
                  <AttendanceItem
                     ...
                     columnTwoText={item.fullName || "Not Provided"}
                     columnThreeText={item.accountNumber || "Not Provided"}
                     columnFourText={item.companyName || "Not Provided"}
                  />
               );
            })}
         </div>
            ...
            {proxies.map((item, index) => {
               ...
               return (
                  <AttendanceItem
                     ...
                     columnThreeText={item.accountNumber || "Not Provided"}
                     columnFourText={
                        item.companyName || "Not Provided" || "Not Provided"
                     }
                  />
               );
            })}
